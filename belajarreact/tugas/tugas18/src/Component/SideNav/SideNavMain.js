...
import SideNavHeader from '../SideNav/SideNavContain/SideNavHeader';
import SideNavSubHeader from '../SideNav/SideNavContain/SideNavSubHeader';
import listDataSideNav from '../../Data/dataSideNav';

const SideNavMain = ()=> {
    const [dataNav] = useState(listDataSideNav);

    return(
    <>
    <br />
    <SideNav
        trigger={<Button icon={<Icon>dehaze</Icon>}></Button>}
        options={{
            closeOnClick    : true,
        }}
    >
        ...
        {dataNav.dataSideNavHeader.map((item, index)=>(
        <SideNavHeader 
            key={index}
            icon={item.icon}
        ...
        {dataNav.dataSideNavSubHeader.map((item,index)=>(
        <SideNavSubHeader 
            key={index}
